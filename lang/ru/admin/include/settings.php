...
$MESS['ALS_CROSSPOSTING_SETTINGS_TITLE'] = 'Кросcпостинг: настройки';

$MESS['ALS_CROSSPOSTING_SETTINGS_VK_TITLE'] = 'ВКонтакте';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_CLIENT_ID'] = 'Идентификатор приложения';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_OWNER_ID'] = 'Идентификатор пользователя/сообщества';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_FROM_GROUP'] ='Публиковать от имени сообщества';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_ACCESS_TOKEN'] = 'Токен доступ';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_REFRESH_TOKEN'] = 'Токен обмена';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_ID_TOKEN'] = 'JWT пользователя';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_DEVICE_ID'] = 'Идентификатор устройства';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_GET_TOKENS'] = 'Получить токены ВКонтакте';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_UPDATE_TOKENS'] = 'Обновить токены';
$MESS['ALS_CROSSPOSTING_SETTINGS_VK_INSTRUCTION'] = '
...
<ol>
    ...
    <li>Укажите базовый домен и заполните доверенный Redirect URL значением "#DOMAIN#/bitrix/admin/als-crossposting-settings.php".</li>
...
$MESS['ALS_CROSSPOSTING_SETTINGS_TELEGRAM_TITLE'] = 'Телеграм';
$MESS['ALS_CROSSPOSTING_SETTINGS_TELEGRAM_ACCESS_TOKEN'] = 'Токен доступа бота ';
$MESS['ALS_CROSSPOSTING_SETTINGS_TELEGRAM_CHAT_USER_NAME'] = 'Юзернейм чата (с начальным @)';
$MESS['ALS_CROSSPOSTING_SETTINGS_TELEGRAM_INSTRUCTION'] = '
